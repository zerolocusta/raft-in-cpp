...
void TableStruct::InitDefaultsImpl() {
  ...
  _CommandResponse_default_instance_.get_mutable()->result_ = const_cast< ::raft_msg::KVEntry*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      " \002(\t\022)\n\003err\030\004 \001(\0162\034.raft_msg.CommandResp"
      "onseErr\022!\n\006result\030\005 \001(\0132\021.raft_msg.KVEnt"
      "ry"
  };
...
CommandResponse::CommandResponse(const CommandResponse& from)
  ...
  if (from.has_result()) {
    result_ = new ::raft_msg::KVEntry(*from.result_);
  } else {
    result_ = NULL;
  }
...
// @@protoc_insertion_point(message_clear_start:raft_msg.CommandResponse)
  if (_has_bits_[0 / 32] & 3u) {
    ...
    if (has_result()) {
      ...
      result_->::raft_msg::KVEntry::Clear();
    }
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:raft_msg.CommandResponse)
  ...
  if (from._has_bits_[0 / 32] & 31u) {
    ...
    if (from.has_result()) {
      mutable_result()->::raft_msg::KVEntry::MergeFrom(from.result());
    }
...
const ::raft_msg::KVEntry& CommandResponse::result() const {
  // @@protoc_insertion_point(field_get:raft_msg.CommandResponse.result)
  return result_ != NULL ? *result_
                         : *::raft_msg::KVEntry::internal_default_instance();
}
::raft_msg::KVEntry* CommandResponse::mutable_result() {
  set_has_result();
  if (result_ == NULL) {
...
::raft_msg::KVEntry* CommandResponse::release_result() {
...
void CommandResponse::set_allocated_result(::raft_msg::KVEntry* result) {
  delete result_;
  result_ = result;
  if (result) {
    set_has_result();
